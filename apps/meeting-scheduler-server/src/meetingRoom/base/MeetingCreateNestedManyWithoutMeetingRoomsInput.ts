...
@InputType()
class MeetingCreateNestedManyWithoutMeetingRoomsInput {
...
export { MeetingCreateNestedManyWithoutMeetingRoomsInput as MeetingCreateNestedManyWithoutMeetingRoomsInput };
